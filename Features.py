...
def YouTubeSearch(term):
    ...
    Speak("This May Also Help You Jay.")

def Alarm(query):

    TimeHere=  open('E:\\Jarvis\\JARVIS.9869\\Data.txt','a')
    TimeHere.write(query)
    TimeHere.close()
    os.startfile("E:\\Jarvis\\JARVIS.9869\\DataBase\\ExtraPro\\Alarm.py")
...
def DownloadYouTube():
    ...
    os.startfile('E:\\How To Make Jarvis\\DataBase\\Youtube\\')

def SpeedTest():

    os.startfile("E:\\How To Make Jarvis\\DataBase\\Gui Programs\\SpeedTestGui.py")
